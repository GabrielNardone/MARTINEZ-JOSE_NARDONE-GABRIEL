...
public class OdontologoDaoH2 implements IDao<Odontologo> {
    ...
    public Odontologo guardar(Odontologo odontologo) {
        ...
        try {
            ...
            connection.commit();
            LOGGER.info("The dentist was registered: " + odontologo);
    ...
    public List<Odontologo> listarTodos() {
        ...
        try {
            ...
            LOGGER.info("Complete dentist list: \n" + odontologos);
    ...
    public void eliminar(int id) {
        ...
        try {
            ...
            ps.execute();
            connection.commit();
            LOGGER.info("The dentist with id: " + id + " was deleted.");
    ...
    public Odontologo buscarPorId(int id) {
        ...
        try {
            ...
            LOGGER.info("The dentist with id: " + id + " was found: \n" + odontologo);
    ...
    public Odontologo actualizar(Odontologo odontologo) {
        ...
        try {
            ...
            ps.execute();
            connection.commit();
            LOGGER.warn("The dentist with id: " + odontologo.getId() + " was updated. " + odontologo);
