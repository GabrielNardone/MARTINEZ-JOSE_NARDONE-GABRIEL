...
public class PacienteDaoH2 implements IDao<Paciente> {
    ...
    public Paciente guardar(Paciente paciente) {
        ...
        try {
            ...
            connection.commit();
            LOGGER.info("The patient: " + paciente + " was registered");
            ...
            try {
                ...
                LOGGER.error("An error occurred while closing DB " + e.getMessage());
                e.printStackTrace();
            }
        }
    ...
    public List<Paciente> listarTodos() {
        ...
        try {
            ...
            LOGGER.info("Complete patients list: \n" + pacientes);
    ...
    public void eliminar(int id) {
        ...
        try {
            ...
            ps.execute();
            connection.commit();
            LOGGER.info("The patient with id: " + id + " was deleted.");
    ...
    public Paciente buscarPorId(int id) {
        ...
        try {
            ...
            LOGGER.info("The patient with id " + id + " was found: \n" + paciente);
    ...
    public Paciente buscarPorCriterio(String criterio) {
        ...
        try {
            ...
            LOGGER.info("The patient with dni " + criterio + " was found: \n" + paciente);
    ...
    public Paciente actualizar(Paciente paciente) {
        ...
        try {
            ...
            ps.execute();
            connection.commit();
            LOGGER.warn("The patient with id " + paciente.getId() + " was updated. " + paciente);
    ...
    private Paciente crearObjetoPaciente(ResultSet resultSet) throws SQLException {
        ...
        Odontologo odontologoPaciente = new OdontologoDaoH2().buscarPorId(resultSet.getInt("odontologo_id"));
        return new Paciente(idPaciente, nombrePaciente, apellidoPaciente, dniPaciente, fechaIngreso, domicilioPaciente, odontologoPaciente);
    }
